...
public final class CustomarReg_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("                        </li>\n");
      out.write("                         <li><a href=\"ShowAlcustlRecharge.jsp\">Show All Recharge</a></li>\n");
      out.write("                    </ul>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      ...
      out.write("                    <h3>CUSTOMER REGISTRATION FORM</h3></div>\n");
      out.write("                <div  style=\"height:40px;  margin-left:350px; float:left; background-color: #1ab188\">\n");
      out.write("                    <h3>CUSTOMER RECHARGE</h3></div>\n");
      out.write("            </div>\n");
      out.write("\n");
      out.write("\n");
      out.write("            <div ng-app=\"exampleApp\" id=\"todoPanel\" class=\"panel\" ng-controller=\"defaultCtrl\">\n");
      out.write("\n");
      out.write("                <form name=\"myForm\"  style=\"width: 800px; float: left; overflow: hidden;\" method=\"post\" action=\"CustomarRegSublet\" novalidate>\n");
      out.write("                    <div class=\"well\">\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <label>Customer Phone Number: ");
      ...
      out.write("                            <span ng-show=\"myForm.phoneNumber.$invalid && myForm.phoneNumber.$dirty\">Number must be  11 crecter</span>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <label>Recharge Amount:</label>\n");
      out.write("                            <input name=\"rechargeAmount\" type=\"number\" ng-model=\"newUser.rechargeAmount\" placeholder=\"00\"  ng-pattern=\"/^[0-9]{2,4}$/\" class=\"form-control\" Required >\n");
      out.write("                            <span ng-show=\"myForm.rechargeAmount.$invalid && myForm.rechargeAmount.$dirty\">Must be Number</span>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <label>Customer Full Name:</label>\n");
      ...
      out.write("                            <span ng-show=\"myForm.name.$invalid && myForm.name.$dirty\">Name must be 3-25 crecter</span>\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        <div class=\"form-group\">\n");
      ...
      out.write("                            <input name=\"occupation\" type=\"text\" ng-model=\"newUser.occupation\" placeholder=\"Occupation\" ng-pattern=\"/^[A-Za-z -_]{3,25}$/\" class=\"form-control\" Required>\n");
      out.write("                            <span ng-show=\"myForm.occupation.$invalid && myForm.occupation.$dirty\">Occupation  Required</span>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <label>Contract Number:</label>\n");
      ...
      out.write("                            <span ng-show=\"myForm.altNumber.$invalid && myForm.altNumber.$dirty\">Number must be  11 crecter</span>\n");
      out.write("                        </div>\n");
      out.write("\n");
      ...
      out.write("\n");
      out.write("                </form>\n");
      out.write("                <form name=\"myForm2\"  style=\"width: 360px; float: left; overflow: hidden;\" method=\"post\" action=\"CusrechargrSublet\" novalidate>\n");
      out.write("                    <div class=\"well\">\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <label>Customer Phone Number:</label>\n");
      out.write("                            <input name=\"cphoneNumber\" type=\"number\" ng-model=\"newUser.cphoneNumber\" placeholder=\"01900000000\"  ng-pattern=\"/^[0-9]{11}$/\" class=\"form-control\"  Required>\n");
      out.write("                            <span ng-show=\"myForm.cphoneNumber.$invalid && myForm.phoneNumber.$dirty\">Number must be  11 character</span>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <label>Recharge Amount:</label>\n");
      out.write("                            <input name=\"crechargeAmount\" type=\"number\" ng-model=\"newUser.crechargeAmount\" placeholder=\"00\"  ng-pattern=\"/^[1-9]+[0-9]+$/\" class=\"form-control\" Required >\n");
      out.write("                            <span ng-show=\"myForm.crechargeAmount.$invalid && myForm.rechargeAmount.$dirty\">Must be Number</span>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <label>AGENT Number:</label>\n");
      ...
      out.write("                            <span ng-show=\"myForm.aphoneNumber.$invalid && myForm.phoneNumber.$dirty\">Number must be  11 character</span>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"checkbox\">\n");
      out.write("                            <label>\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.cusRechargeMassage}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("</div>\n");
      out.write("                </form>        \n");
      out.write("\n");
      out.write("            </div>\n");
