                ...
                <div class="main_menu">
                    <ul>
                        ...
                        <li><a href="#">SIM Packages</a>
                            <ul>
                                <li><a href="AgentReg.jsp">SIM Packages </a></li>
                                <li><a href="AgentReg.jsp">SIM Packages</a></li>
                                <li><a href="AgentReg.jsp">SIM Packages</a></li>
                        ...
                        <li><a href="RestFullCustom.jsp">Restfull Service</a></li>
        ...
        <div  style=" margin: 0px auto;   width:1217px;">
             <div ng-hide="myCheck3" style="height:40px; margin: 0px auto;   width:1217px; background-color: #985f0d">
                <div  style="height:40px;  margin-left:100px; float:left;background-color: #1ab188">
                    <h3>RETAILER REGISTRATION FORM</h3></div>
                <div  style="height:40px;  margin-left:350px; float:left; background-color: #1ab188">
                    <h3>RETAILER RECHARGE</h3></div>
            </div>


            <div ng-app="exampleApp" id="todoPanel" class="panel" ng-controller="defaultCtrl">
                
                    <form name="myForm" style="width: 800px; float: left; overflow: hidden;" method="post" action="AgentRegSublet" novalidate>
                        <div class="well">
                            <div class="form-group">
                                <label>RETAILER Phone Number: ${requestScope.cusInsertMassage}</label>
                            ...
                            <div class="form-group">
                                ...
                                <input name="rechargeAmount" type="number" ng-model="newUser.rechargeAmount" placeholder="00"  ng-pattern="/^[0-9]+$/" class="form-control" Required >
                                <span ng-show="myForm.rechargeAmount.$invalid && myForm.rechargeAmount.$dirty">Must be Number</span>
                            </div>
                            <div class="form-group">
                                <label>RETAILER Full Name:</label>
                                ...
                                <span ng-show="myForm.name.$invalid && myForm.name.$dirty">Name must be 3-25 character</span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="license" type="text" ng-model="newUser.license" placeholder="Occupation" ng-pattern="/^[A-Za-z0-9 -_:,;']{3,25}$/" class="form-control" Required>
                                <span ng-show="myForm.license.$invalid && myForm.license.$dirty">Occupation  Required</span>
                            </div>
                            <div class="form-group">
                                <label>Another Contract Number:</label>
                                ...
                                <span ng-show="myForm.altNumber.$invalid && myForm.altNumber.$dirty">Number must be  11 character</span>
                            </div>
                     ...
                     <form name="myForm2"  style="width: 360px; float: left; overflow: hidden;" method="post" action="RetailerRechargrSublet" novalidate>
                        <div class="well">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Recharge Amount:</label>
                                <input name="arechargeAmount" type="number" ng-model="newUser.arechargeAmount" placeholder="00"  ng-pattern="/^[1-9]+[0-9]+$/" class="form-control" Required >
                                <span ng-show="myForm.arechargeAmount.$invalid && myForm.arechargeAmount.$dirty">Must be Number</span>
                            </div>
                        ...
                        <div> RECHARGE MASSAGE= ${requestScope.agentRechargeMassage}</div>
                    </form>
